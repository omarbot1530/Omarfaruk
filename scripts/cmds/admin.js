...
module.exports = {
	config: {
		...
		author: "NTKhang",
		countDown: 5,
		role: 0, // role 0 করা হয়েছে যাতে সবাই list দেখতে পারে
		description: {
	...
	langs: {
		...
		en: {
            ...
            noPermission: "⚠️ | এই কমান্ডটি ব্যবহার করার অনুমতি আপনার নেই।"
		}
	},

	onStart: async function ({ message, args, usersData, event, getLang }) {
		const { senderID } = event;
        const botOwnerID = config.adminBot[0]; // বটের মালিকের ID
